...
int minMax(int joueurActuel, int joueurIA, int ProfondeurActuelle,
    ...
    int val;
    if (ProfondeurActuelle == ProfondeurMaximum) {
        ...
        if (joueurActuel != joueurIA) {
            ...
            while (true) {
                ...
                val = min(val, minMax((joueurActuel + 1) % 2, joueurIA, ProfondeurActuelle + 1, ProfondeurMaximum,
                                      meilleurCoup, alpha, beta));
            ...
            while (true) {
                ...
                val = max(val, minMax((joueurActuel + 1) % 2, joueurIA, ProfondeurActuelle + 1, ProfondeurMaximum,
                                      meilleurCoup, alpha, beta));
